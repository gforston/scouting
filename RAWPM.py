...
TEAM_ADJUST = ((41+42) / 42) * 2.75 #team 1 point ranking + team 2 point ranking /122 * 2.75
TEAMS_AVG = ((22+23) / 42) * 2.75 # average team adjustment

RPW = (POINTS * POINTS_COEF) + (HIGH * HIGH_COEF) + (LOW * LOW_COEF) + (AUTOPTS * AUTOPTS_COEF) + (NUMPIECES * NUMPIECES_COEF) 
